...
console.log(`Car 33 is a ${inventory[32].car_year} car, a ${inventory[32].car_make} and the model is ${inventory[32].car_model}`);
...
console.log(`The last Car is a ${inventory[lastCar].car_year} car, a ${inventory[lastCar].car_make} and the model is ${inventory[lastCar].car_model}`);
